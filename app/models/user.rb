class User < ActiveRecord::Base
  ...
  def create_demo_data
    ...
    p=Project.create!(:name => "Agi Project", :start => "2010-10-01", :end => "2010-11-17", :status => :ongoing, :organization_id => o1.id)
    ...
    p=Project.create!(:name => "Doomed", :start => "2010-09-01", :end => "2011-12-17", :status => :on_hold, :organization_id => o1.id)
    Participation.create!(:user_id => u[0].id, :project_id => p.id)
    Participation.create!(:user_id => u[1].id, :project_id => p.id)
    ...
    p=Project.create!(:name => "Cash Cow", :start => "2010-10-17", :end => "2011-03-01", :status => :on_going, :organization_id => o1.id)
    Participation.create!(:user_id => u[1].id, :project_id => p.id)
    Participation.create!(:user_id => u[2].id, :project_id => p.id)
    Participation.create!(:user_id => u[3].id, :project_id => p.id)
    ...
    p=Project.create!(:name => "Portal Project", :start => "2010-09-01", :end => "2011-01-01", :status => :on_going, :organization_id => o2.id)
    ...
    p=Project.create!(:name => "Personal Homepage", :start => "2010-10-01", :end => "2010-12-15", :status => :completed, :organization_id => o2.id)
    ...
    Participation.create!(:user_id => self.id, :project_id => p.id)
    p=Project.create!(:name => "Garage Project", :start => "2010-10-15", :end => "2010-11-30", :status => :ongoing, :organization_id => o2.id)
    Participation.create!(:user_id => self.id, :project_id => p.id)
